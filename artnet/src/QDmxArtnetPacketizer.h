...
#ifndef QDMXARTNETPACKETIZER_H
#define QDMXARTNETPACKETIZER_H
...
class QDmxArtNetPacketizer
{
    /*********************************************************************
     * Initialization
     *********************************************************************/
public:
    QDmxArtNetPacketizer();
    ~QDmxArtNetPacketizer();
...
public:
    ...
    void setupArtNetPollReply(QByteArray &data, ArtNetNodeInfo& info, QHostAddress ipAddr, QString MACaddr);
